...
import { MovieResult } from "@customTypes/MovieResponse";
import getMovieRuntimeInHours from "@utils/getMovieRuntimeInHours";
...
function MovieInfoTab({ show }: TabsProps) {
	return (
							...
							<div className="space-y-4">
								...
								{!show?.movie_cast ? (
									...
									<div className="flex flex-grow flex-wrap gap-4 overflow-hidden">
										{show.movie_cast.results.slice(0, 5).map((member) => (
											<div
												key={nanoid()}
						...
						<div className="space-y-6">
							...
							<div className="space-y-2">
								...
								<div className="divide-y">
									...
									{/* runtime */}
									<p className="space-x-2 py-2">
										<span className="font-semibold capitalize">runtime</span>
										<span className="text-gray-300">
											{getMovieRuntimeInHours(show.runtime)}
										</span>
									</p>
									{/* origin */}
									<p className="space-x-2 py-2">
									...
									{/* tagline */}
									<p className="space-x-2 py-2">
										<span className="font-semibold capitalize">tagline</span>
										<span className="text-gray-300">{show.tagline}</span>
									</p>
								</div>
							</div>
						</div>
